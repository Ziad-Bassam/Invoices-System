            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ url('invoices/update') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="inputName" class="control-label">Invoice
                                    number</label>
                                <input type="hidden" name="invoice_id" value="{{ $invoices->id }}">
                                <input value="{{ $invoices->invoice_number }}" type="text" class="form-control"
                                    id="inputName" name="invoice_number" title="Please enter the invoice number" required>
                            </div>
                            <div class="col">
                            ...
                            <div class="col">
                                ...
                                <input value="{{ $invoices->due_date }}" class="form-control fc-datepicker" name="due_date"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input value="{{ $invoices->amount_collection }}" type="text" class="form-control"
                                    id="amount_collection" name="amount_collection"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input value="{{ $invoices->amount_commission }}" type="text"
                            ...
                            <div class="col">
                                ...
                                <input value="{{ $invoices->discount }}" type="text"
