...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Invoices</h4><span class="text-muted mt-1 tx-16 mr-2 mb-0">/ Archive
                    invoices</span>
            </div>
        </div>
    </div>
...
@section('content')
    ...
    @if (session()->has('edit'))
        <script>
            window.onload = function() {
                notif({
                    msg: "The invoice has been removed from the archive",
                    type: "success"
                })
            }
        </script>
