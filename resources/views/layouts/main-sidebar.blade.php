...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        <h3 style="color: blue">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Invoices</h3>
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="side-item side-item-category">Invoicer</li>
            <li class="slide">
            ...
            @can('invoices')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('paid invoices')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invoices_paid')) }}">Paid invoices</a></li>
                        @endcan

                        @can('unpaid invoices')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invoices_unpaid')) }}">Unpaid invoices</a>
                            </li>
                        @endcan

                        @can('Partially paid invoices')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invoices_partial')) }}">Partially paid
                                    invoices</a>
                            @endcan
