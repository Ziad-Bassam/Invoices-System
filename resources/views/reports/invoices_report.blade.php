            ...
            <div class="card-header pb-0">
                ...
                <form action="/search_invoices" method="POST" role="search" autocomplete="off">
                    ...
                    <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                        <label class="rdiobox"><input name="rdio" value="2" type="radio"><span>Search by invoice number</span></label>
                    </div><br><br>

                    <div class="row">

                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                            <p class="mg-b-10">Select the type of invoices</p><select class="form-control select2" name="type"
                                required>
