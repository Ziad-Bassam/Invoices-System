...
@section('content')
                        ...
                        <table id="example1" class="table key-buttons text-md-nowrap">
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-bottom-0">Section name</th> {{-- اسم القسم --}}
                                    <th class="border-bottom-0">Description</th> {{-- ملاحظات --}}
                                    <th class="border-bottom-0">Actions</th> {{-- العمليات --}}
                                </tr>
                            </thead>
                            <tbody>
                                @php
    ...
    <div class="modal" id="modaldemo9">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">Delete the section</h6><button aria-label="Close" class="close"
